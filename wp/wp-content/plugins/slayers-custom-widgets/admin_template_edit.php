...
if(!isset($_GET['id']) || empty($wp_registered_widgets[$_GET['id']]))
	...
	if(!empty($_GET['opt'])){
		...
		echo '<table class="form-table">';
			echo '<tr>';
				echo '<th scope="row" style="width:200px;padding:5px 0px;">';
					
					echo '<div class="slayer_wrapper">';
						echo '<h3>Options</h3>';
						...
						echo '<a class="button" onclick="if(!confirm(\'Are you sure you want to reset this widget?\')) return false;" href="',$url,'&amp;reset_widget">Reset this widget</a><div class="clear"></div><br/>';
						
					echo '</div>';
				echo '</th>';
				echo '<td>';
					echo '<ul class="slayer_list widget-list">';
						...
						foreach($this->info['blank'] as $group => $data )
							...
							echo '<li class="widget-list-item widget-list-control-item" style="height:auto;">';
							
								echo '<h4 class="widget-title">', $group ,' ( <a href="',$url,'&amp;opt=', $group ,'">Edit</a> )</h4>';
					...
					echo '<form action="" method="post"><div id="rbet_extended">';
						
						echo '<h3>Extended features ( Assign a Widget to a specific WP template )';
						...
						echo '<p class="submit"><input type="submit" value="save" /></p>';
